...
import {
  ...
  type PrepareThreadHandoffInput,
  type DismissThreadHandoffInput,
...
export type {
  ...
  PrepareThreadHandoffInput,
  DismissThreadHandoffInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    prepareHandoff: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:prepare-handoff",
      execute: (input: PrepareThreadHandoffInput) => prepareThreadHandoff(input),
      scheduler,
      concurrency,
    }),
    dismissHandoff: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:dismiss-handoff",
      execute: (input: DismissThreadHandoffInput) => dismissThreadHandoff(input),
      scheduler,
      concurrency,
    }),
    startHandoff: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:start-handoff",
